...
// do, e.g. "Authentication & Security", "API & Backend Services") would
// otherwise produce a different signed byte sequence than what the backend
// verifies against, failing the device signature. SetEscapeHTML(false) here
