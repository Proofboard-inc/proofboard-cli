...
- **Objective**: Create the git tag `v1.8.0` (if not present) and publish a GitHub Release with the compiled binaries.
- **Exit Criteria**:
  ...
  - The four compiled binaries from `build/` (or `dist/`) are uploaded as release assets:
