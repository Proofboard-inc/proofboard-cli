...
Your identity is `explorer_m1_explore_3` and your working directory is `/workspaces/proofboard-cli/.agents/explorer_m1_explore_3/`.
...
4. Write your analysis to `/workspaces/proofboard-cli/.agents/explorer_m1_explore_3/analysis.md` and a final handoff report at `/workspaces/proofboard-cli/.agents/explorer_m1_explore_3/handoff.md` following the Handoff Protocol (Observation, Logic Chain, Caveats, Conclusion, Verification Method).
